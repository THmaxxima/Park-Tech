...
Public Class frm_RPT_GRAPH_REMAINING_BY_DAY
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report()
        ...
        Str_Quy = "Select * from QR_GRAPH_CAR_REMAINING_BY_DAY "
        ...
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_REMAINING_BY_DAY
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_REMAINING_BY_DAY
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If

    End Sub

    Private Sub frm_RPT_GRAPH_REMAINING_BY_DAY_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
