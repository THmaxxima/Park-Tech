...
Public Class frm_RPT_GRAPH_CAR_PARKING_BY_MONTH_BY_FLOOR
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report()
        ...
        Str_Quy = "Select * from QR_GRAPH_CAR_PARKING_BY_MONTH_BY_FLOOR "
        ...
        Str_Quy &= " GROUP BY [Trn_Building_ID] "
        Str_Quy &= " ,[Building_Name] "
        Str_Quy &= " ,[Trn_Tower_ID] "
        Str_Quy &= " ,[Tower_Name] "
        Str_Quy &= " ,[Trn_Month] "
        Str_Quy &= " ,[Trn_Month_Name] "
        Str_Quy &= " ,[Trn_Floor_No] "
        Str_Quy &= " ,[Floor_Name] "
        Str_Quy &= " ,[Trn_ValuesIn] "
        Str_Quy &= " ,[Trn_ValuesOut] "
        Str_Quy &= " ,[Trn_Date] "
        Str_Quy &= " order by Trn_Tower_ID,Trn_Building_ID,Trn_Floor_No,Trn_Date "

        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)

        Dim RPT As Object
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_CAR_PARKING_BY_MONTH_BY_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_CAR_PARKING_BY_MONTH_BY_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If


    End Sub
    Private Sub frm_RPT_GRAPH_CAR_PARKING_BY_MONTH_BY_FLOOR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
