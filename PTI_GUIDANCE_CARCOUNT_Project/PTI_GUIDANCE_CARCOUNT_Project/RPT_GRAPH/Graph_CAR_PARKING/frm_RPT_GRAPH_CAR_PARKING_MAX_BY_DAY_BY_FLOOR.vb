...
Public Class frm_RPT_GRAPH_CAR_PARKING_MAX_BY_DAY_BY_FLOOR
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Private Sub frm_RPT_GRAPH_CAR_PARKING_BY_DAY_BY_FLOOR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub Query_Report_ByTower()
        ...
        Str_Quy = "SELECT Trn_Date, maxparking, minparking "

        Str_Quy &= "  FROM [PTI_GUIDANCE_CARCOUNT_Project].[dbo].[V_RPT_GRAPH_MAX_MIN] "
        ...
        Str_Quy &= " group by Trn_Date, maxparking, minparking "
        Str_Quy &= " order by Trn_Date"

        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)

        Dim RPT As Object
        RPT = New LINE_RPT_GRAPH_CAR_PARKING_MAX_BY_DAY_BY_FLOOR
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)

        'If rdo_Bar.Checked = True Then
        '    RPT = New BAR_RPT_GRAPH_CAR_PARKING_BY_DAY_BY_FLOOR
        '    ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        'End If
    ...
    Sub Query_Report_ByBuilding()
        ...
        'Str_Quy = "Select * from QR_GRAPH_CAR_PARKING_BY_DAY_BY_FLOOR "
        ...
        'Str_Quy &= " order by Trn_Tower_ID,Trn_Building_ID,Trn_Log_Date,Trn_Floor_No"
        ...
        'End If
        'If rdo_Line.Checked = True Then
        '    RPT = New LINE_RPT_GRAPH_CAR_PARKING_BY_DAY_BY_FLOOR
        '    ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        'End If
