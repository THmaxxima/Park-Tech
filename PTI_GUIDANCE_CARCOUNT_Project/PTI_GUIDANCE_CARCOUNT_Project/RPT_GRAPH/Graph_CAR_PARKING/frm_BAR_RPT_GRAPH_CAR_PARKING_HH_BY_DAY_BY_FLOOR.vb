...
Public Class frm_BAR_RPT_GRAPH_CAR_PARKING_HH_BY_DAY_BY_FLOOR
 ...
 Optional ByRef DateEnd As String = "")
    ...
    End Sub
    Private Sub frm_BAR_RPT_GRAPH_CAR_PARKING_HH_BY_DAY_BY_FLOOR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Show.Click
        ...
        If rdo_Detail.Checked = True Then
            Call Query_Report()
        End If
        If rdo_Sum.Checked = True Then
            Call Query_Report_Summary()
        End If

        btn_Show.Enabled = True
    End Sub
    Sub Query_Report_Summary()
        Dim Str_Quy As String = ""
        Dim pDtb_Qury As DataTable
        Dim DateSt As DateTime
        Dim DateEnd As DateTime
        ...
        Str_Quy = "Select * from QR_GRAPH_CAR_PARKING_SUM_HH_BY_DAY_BY_FLOOR "
        Str_Quy &= " where (Trn_Log_Date between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        Dim RPT As Object
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_CAR_PARKING_SUM_HH_BY_DAY_BY_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_CAR_PARKING_SUM_HH_BY_DAY_BY_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
