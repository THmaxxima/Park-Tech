...
Public Class frm_RPT_GRAPH_IN_OUT_REMAINING_15_MM
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report()
        ...
        Str_Quy = " Select * from QR_GRAPH_CAR_REMAINING_BY_15_MM "
        ...
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_IN_OUT_REMAINING_15_MM
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_IN_OUT_REMAINING_15_MM
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
    ...
    Sub Query_Report_ByTower()
        ...
        Str_Quy = "Select * from QR_GRAPH_CAR_REMAINING_BY_15_MM_TOWER "
        Str_Quy &= " where (Trn_Time_MM_Start15 between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        Dim RPT As Object
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_IN_OUT_REMAINING_15_MM_TOWER
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_IN_OUT_REMAINING_15_MM_TOWER
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
    ...
    Sub Query_Report_Floor()
        ...
        Str_Quy = "Select * from QR_GRAPH_CAR_REMAINING_BY_15_MM_FLOOR "
        Str_Quy &= " where (Trn_Time_MM_Start15 between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        Dim RPT As Object
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_IN_OUT_REMAINING_15_MM_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_IN_OUT_REMAINING_15_MM_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If

    End Sub
    Private Sub frm_RPT_GRAPH_IN_OUT_REMAINING_15_MM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
