...
Public Class frm_RPT_GRAPH_IN_OUT_BY_30_MM
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report()
        ...
        Str_Quy = "Select * from QR_GRAPH_CAR_IN_OUT_BY_30_MM "
    ...
    Sub Query_Report_TOWER()
        ...
        Str_Quy = "Select * from QR_GRAPH_CAR_IN_OUT_BY_30_MM_TOWER "
        Str_Quy &= " where (Trn_Time_MM_Start30 between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_IN_OUT_BY_30_MM_TOWER
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_IN_OUT_BY_30_MM_TOWER
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
    ...
    Sub Query_Report_FLOOR()
        ...
        Str_Quy = "Select * from QR_GRAPH_CAR_IN_OUT_BY_30_MM_FLOOR "
        Str_Quy &= " where (Trn_Time_MM_Start30 between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_IN_OUT_BY_30_MM_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_IN_OUT_BY_30_MM_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If

    End Sub
    Private Sub frm_RPT_GRAPH_IN_OUT_BY_30_MM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
