...
Public Class frmRPT_GRAPH_CAR_PARKING_BY_30MM
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report()
        ...
        Str_Quy = " Select * from QVR_CAR_PARKING_30MM_BY_BUILDING "
        ...
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_CAR_PARKING_BY_30MM_BUIDING
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_CAR_PARKING_BY_30MM_BUIDING
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
    ...
    Sub Query_Report_ByTower()
        ...
        Str_Quy = "Select * from QVR_CAR_PARKING_30MM_BY_TOWER "
        Str_Quy &= " where (Trn_Time_MM_Start15 between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        Dim RPT As Object
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_CAR_PARKING_BY_30MM_TOWER
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_CAR_PARKING_BY_30MM_TOWER
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
    ...
    Sub Query_Report_Floor()
        ...
        Str_Quy = "Select * from QVR_CAR_PARKING_30MM_BY_FLOOR "
        Str_Quy &= " where (Trn_Time_MM_Start15 between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        Dim RPT As Object
        If rdo_Bar.Checked = True Then
            RPT = New BAR_RPT_GRAPH_CAR_PARKING_BY_30MM_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
        If rdo_Line.Checked = True Then
            RPT = New LINE_RPT_GRAPH_CAR_PARKING_BY_30MM_FLOOR
            ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
        End If
    ...
    End Sub
    Private Sub frmRPT_GRAPH_CAR_PARKING_BY_30MM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
