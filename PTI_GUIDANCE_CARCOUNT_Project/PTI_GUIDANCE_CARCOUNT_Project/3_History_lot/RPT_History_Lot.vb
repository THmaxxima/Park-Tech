...
Public Class RPT_History_Lot
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PTI_GUIDANCE_CARCOUNT_Project.RPT_History_Lot.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_History_Lot
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_History_Lot = New RPT_History_Lot()
        rpt.Site = Me.Site
        Return rpt
    End Function
