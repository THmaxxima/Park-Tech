...
Public Class frm_Lot_History_New
    Friend Lot_id As String = ""
    Friend Buiding_id As String = "1"
    Friend floor_no As String = "1"
    Friend date_st As DateTime
    Friend date_end As DateTime
    Dim DT As New DataTable

    Dim sql_find As String = ""
    Dim cdb As New CDatabase
    Private Sub frm_Lot_History_New_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
...
Optional ByRef DateEnd As String = "")
        Try
            ...
            Dim paraTotalHH As New ParameterField

            Dim paraTotalMM As New ParameterField
            ...
            paraTotalHH.ParameterFieldName = "Total_HH"
            DisCreatValue_ = New ParameterDiscreteValue
            DisCreatValue_.Value = Label7.Text
            paraTotalHH.CurrentValues.Add(DisCreatValue_)
            MainParaField.Add(paraTotalHH)

            paraTotalMM.ParameterFieldName = "Total_MM"
            DisCreatValue_ = New ParameterDiscreteValue
            DisCreatValue_.Value = Label9.Text
            paraTotalMM.CurrentValues.Add(DisCreatValue_)
            MainParaField.Add(paraTotalMM)


            Dim frm As New Print_Preview_H
            frm.CTR_Viewer.ParameterFieldInfo = MainParaField
            SqlReport.SetDataSource(Dtb_Report)
            frm.CTR_Viewer.ReportSource = SqlReport
            frm.ShowDialog()
