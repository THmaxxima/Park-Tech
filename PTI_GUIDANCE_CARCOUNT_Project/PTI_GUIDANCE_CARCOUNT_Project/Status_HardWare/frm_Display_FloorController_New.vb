...
Public Class frm_Display_FloorController_New
    ...
    Dim G As Integer = 0
    Dim B As Integer = 0
    Dim ip_workstation As String = ""
    Dim ip_server As String = ""


    Private Sub frm_Display_FloorController_New_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Zcu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        zcu_name = lbl_.name
        Dim frm As New frmNew_Display_Single
        With frm
            .Building_ID = buiding
            .ZCU_ID = zcu
            .Floor_no = floor
    ...
    Private Sub frm_Display_FloorController_New_Resize(sender As Object, e As System.EventArgs) Handles Me.Resize

        frm_Display_FloorController_New_Load(e, Nothing)
    End Sub
