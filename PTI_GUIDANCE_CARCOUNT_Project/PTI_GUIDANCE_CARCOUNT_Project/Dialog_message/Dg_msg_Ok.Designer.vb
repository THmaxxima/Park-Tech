...
Partial Class Dg_msg_Ok
    ...
    Private Sub InitializeComponent()
        ...
        Me.Lb_message.ForeColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(195, Byte), Integer), CType(CType(0, Byte), Integer))
