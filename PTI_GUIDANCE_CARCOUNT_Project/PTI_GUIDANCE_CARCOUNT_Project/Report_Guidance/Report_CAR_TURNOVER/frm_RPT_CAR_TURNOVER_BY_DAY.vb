...
Public Class frm_RPT_CAR_TURNOVER_BY_DAY
...
Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByTower()
        ...
        Str_Quy = "Select * from VQR_CAR_TURNOVER_BY_DAY "
        ...
        Dim RPT As Object
        RPT = New RPT_CAR_TURNOVER_BY_DAY_TOWER
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)

    End Sub
    Sub Query_Report_ByTower_ALL()
        Dim Str_Quy As String = ""
        Dim pDtb_Qury As DataTable
        Dim DateSt As DateTime
        Dim DateEnd As DateTime
        ...
        Str_Quy = "Select * from VQR_CAR_TURNOVER_BY_DAY_TOWER "
        Str_Quy &= " where (Trn_Log_Date between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        Str_Quy &= " order by  [Trn_Tower_ID],[Trn_Month],[Trn_Log_Date]"

        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_TURNOVER_BY_DAY_TOWER_ALL
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
    ...
    Sub Query_Report_ByBuilding()
        ...
        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_TURNOVER_BY_DAY
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
    ...
    Sub Query_Report_ByFloor()
        ...
        Str_Quy = "Select * from QA_CAR_TURN_OVER_BY_FLOOR "
        Str_Quy &= " where (Trn_Log_Date between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_TURNOVER_BY_DAY_FLOOR
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)

    End Sub
    Private Sub frm_RPT_CAR_TURNOVER_BY_DAY_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Show.Click
        ...
        If cmb_Floor.SelectedIndex <= 0 And cmb_Building.SelectedIndex <= 0 Then
            Call Query_Report_ByTower_ALL()
