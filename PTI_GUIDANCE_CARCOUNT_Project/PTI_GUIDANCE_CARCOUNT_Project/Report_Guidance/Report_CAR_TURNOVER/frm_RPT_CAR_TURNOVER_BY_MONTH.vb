...
Public Class frm_RPT_CAR_TURNOVER_BY_MONTH
...
Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report()
        ...
        Str_Quy = "Select * from VQR_CAR_TURNOVER_BY_MONTH "
        ...
        Str_Quy &= " order by  [Trn_Tower_ID],[Trn_Month],[Trn_Building_ID],[Trn_Log_Date]"

        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_TURNOVER_BY_MONTH
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)

    End Sub
    Sub Query_Report_ALL()
        Dim Str_Quy As String = ""
        Dim pDtb_Qury As DataTable
        Dim DateSt As DateTime
        Dim DateEnd As DateTime
    ...
    End Sub
    Private Sub frm_RPT_CAR_TURNOVER_BY_MONTH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub Query_Report_ByFloor()
        ...
        Str_Quy = "Select * from [QA_CAR_TURN_OVER_BY_FLOOR_MONTH] "
        Str_Quy &= " where (Trn_Log_Date between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        Str_Quy &= " order by  [Trn_Tower_ID],[Trn_Month],[Trn_Building_ID],[Trn_Floor_No]"

        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_TURNOVER_BY_MONTH_BY_FLOOR
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
