...
Public Class frmRPT_CAR_PARKING_BY_30MM
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report()
        ...
        RPT = New RPT_CAR_PARKING_BY_30MM_BUIDING
    ...
    Sub Query_Report_ByTower()
        ...
        RPT = New RPT_CAR_PARKING_BY_30MM_TOWER
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
    ...
    Sub Query_Report_Floor()
        ...
        RPT = New RPT_CAR_PARKING_BY_30MM_FLOOR
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
    ...
    Private Sub frmRPT_CAR_PARKING_BY_30MM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
