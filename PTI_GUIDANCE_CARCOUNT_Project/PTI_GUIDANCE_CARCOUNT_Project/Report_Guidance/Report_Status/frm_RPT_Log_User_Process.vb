...
Public Class frm_RPT_Log_User_Process
    Dim ClsSqlCmd As New ClassCommandSql
    Friend pHeader_Detail As String
    Private Sub frm_RPT_Log_User_Process_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub Query_Report()
        ...
        Str_Quy = "Select * from QR_RPT_Log_User_Process "
