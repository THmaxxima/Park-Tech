...
Public Class RPT_Status_Sensor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PTI_GUIDANCE_CARCOUNT_Project.RPT_Status_Sensor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Status_Sensor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Status_Sensor = New RPT_Status_Sensor()
        rpt.Site = Me.Site
        Return rpt
    End Function
