...
Public Class RPT_GD_V_Turn_By_Floor_By_Week_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        'Str_Quy = "Select * from GD_V_Turn_By_Floor "
        ...
        'Str_Quy &= " order by Trn_Tower_ID,Trn_Date,Trn_Building_ID,Trn_Floor_No"
        'Str_Quy = "SELECT Trn_Tower_ID, Tower_Name, Trn_Building_ID, Building_Name, Trn_Floor_No, Floor_Name, Floor_Lot_All, convert(varchar,Trn_Year) +'-'+ convert(varchar,Trn_Month) as ym, Trn_Count ,CONVERT(float, CONVERT(float, Trn_Count, 2) / CONVERT(float, Floor_Lot_All, 2), 2) AS Trn_Turn "
        Str_Quy = "SELECT [Trn_Tower_ID],[Tower_Name],[Trn_Building_ID],[Building_Name],[Trn_Floor_No],[Floor_Name],[Floor_Lot_All] "
        Str_Quy &= ",convert(varchar,Trn_Year) + '-' + convert(varchar,Trn_Month) as ym "
        Str_Quy &= ",[Trn_Count] ,[Trn_Turn] "

        Str_Quy &= " FROM Tbl_Report_GD_V_Turn_By_Floor "
        Str_Quy &= " WHERE (Trn_Date between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        Str_Quy &= "GROUP BY Trn_Tower_ID, Tower_Name, Trn_Building_ID, Building_Name, Trn_Floor_No, Floor_Name, Floor_Lot_All, Trn_Month, Trn_Year, Trn_Count,Trn_Turn "
        ...
        Dim RPT As Object
        RPT = New RPT_GD_V_Turn_By_Floor_By_Week
    ...
    End Sub
    Private Sub RPT_GD_V_Turn_By_Floor_frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
