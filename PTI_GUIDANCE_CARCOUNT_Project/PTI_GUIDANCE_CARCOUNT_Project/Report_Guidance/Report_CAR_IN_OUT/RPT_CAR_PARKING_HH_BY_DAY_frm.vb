...
Public Class RPT_CAR_PARKING_HH_BY_DAY_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        'Str_Quy = "Select * from VQR_CAR_PARKING_HH_BY_DAY_BY_FLOOR "
        ...
        'Dim RPT As Object
        'RPT = New RPT_CAR_PARKING_HH_BY_DAY_BY_FLOOR
    ...
    Private Sub RPT_CAR_PARKING_HH_BY_DAY_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
