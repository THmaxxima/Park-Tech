...
Public Class RPT_CAR_FIRST_IN_LAST_OUT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_CAR_FIRST_IN_LAST_OUT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PTI_GUIDANCE_CARCOUNT_Project.RPT_CAR_FIRST_IN_LAST_OUT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CAR_FIRST_IN_LAST_OUT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CAR_FIRST_IN_LAST_OUT = New RPT_CAR_FIRST_IN_LAST_OUT()
        rpt.Site = Me.Site
        Return rpt
    End Function
