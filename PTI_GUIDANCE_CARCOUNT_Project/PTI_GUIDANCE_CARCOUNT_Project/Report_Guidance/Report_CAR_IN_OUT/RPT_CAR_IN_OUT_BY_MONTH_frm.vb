...
Public Class RPT_CAR_IN_OUT_BY_MONTH_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        Str_Quy = "Select * from VQR_CAR_IN_OUT_BY_MONTH_BY_FLOOR "
        ...
        Dim RPT As Object
        RPT = New RPT_CAR_IN_OUT_BY_MONTH_BY_FLOOR
    ...
    Sub Query_Report_ByBuilding()
        ...
        Str_Quy = "Select * from VQR_CAR_IN_OUT_BY_MONTH "
        Str_Quy &= " where (Trn_Log_Date between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_IN_OUT_BY_MONTH
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
    ...
    Sub Query_Report_ByTower()
        ...
        Str_Quy = "Select * from VQR_CAR_IN_OUT_BY_MONTH_TOWER "
        Str_Quy &= " where (Trn_Log_Date between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_IN_OUT_BY_MONTH_TOWER
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)

    End Sub
    Private Sub RPT_CAR_IN_OUT_BY_MONTH_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
