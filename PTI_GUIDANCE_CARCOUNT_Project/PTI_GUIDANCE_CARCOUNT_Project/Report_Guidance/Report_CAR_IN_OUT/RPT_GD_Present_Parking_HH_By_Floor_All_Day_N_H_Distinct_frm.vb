...
Public Class RPT_GD_Present_Parking_HH_By_Floor_All_Day_N_H_Distinct_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        'Str_Quy = "Select * from GD_Present_Parking_HH_By_Floor_All_Day_N_H_Distinct "
        Str_Quy = "Select * from Tbl_Report_GD_Present_Parking_HH_By_Floor_All_Day "
        ...
        Dim RPT As Object
        RPT = New RPT_GD_Present_Parking_HH_By_Floor_All_Day_N_H_Distinct
