...
Public Class RPT_CAR_IN_OUT_BY_1_HH_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        Str_Quy = "Select * from VQR_CAR_IN_OUT_1_HH_BY_FLOOR " 'VQR_CAR_IN_OUT_BY_1_HH_BY_FLOOR
        ...
        Dim RPT As Object
        RPT = New RPT_CAR_IN_OUT_1_HH_BY_FLOOR
        ShowReport(pDtb_Qury, pHeader_Detail & " (แสดงรายละเอียดตามชั้น)", RPT, DateSt, DateEnd)

    End Sub

    Private Sub RPT_CAR_IN_OUT_BY_1_HH_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub Query_Report_ByBuilding()
        ...
        Str_Quy = "Select * from VQR_CAR_IN_OUT_BY_1_HH "
        Str_Quy &= " where (Trn_Time_HH_Start between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_IN_OUT_BY_1_HH
    ...
    Sub Query_Report_ByTower()
        ...
        Str_Quy = "Select * from VQR_CAR_IN_OUT_BY_1_HH_TOWER "
        Str_Quy &= " where (Trn_Time_HH_Start between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_IN_OUT_BY_1_HH_TOWER
    ...
    Private Sub btn_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Show.Click
        ...
        If cmb_Floor.SelectedIndex > 0 Then
            Query_Report_ByFloor()
        Else
            If cmb_Building.SelectedIndex > 0 Then
                Query_Report_ByBuilding()
            Else
