...
Public Class RPT_CAR_PARKING_BY_Week_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        'Str_Quy = "Select * from GD_V_Carcount_By_Floor "
        ...
        Str_Quy &= ", convert(varchar,Trn_Year) + '-' + convert(varchar,Trn_Month) as ym , Trn_Count "
        Str_Quy &= "FROM Tbl_Report_GD_V_Carcount_By_Floor "
        ...
        Str_Quy &= "GROUP BY Trn_Tower_ID , Tower_Name, Trn_Building_ID, Building_Name, Trn_Floor_No, Floor_Name, Floor_Lot_All, Trn_Month, Trn_Month_Name, Trn_Year, Trn_Count "

        Str_Quy &= "ORDER BY Trn_Building_ID, Trn_Floor_No "

        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_IN_OUT_BY_WEEK_BY_FLOOR
