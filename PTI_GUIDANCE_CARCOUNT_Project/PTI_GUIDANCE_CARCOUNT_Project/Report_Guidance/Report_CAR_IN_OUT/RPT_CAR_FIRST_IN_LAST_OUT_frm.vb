...
Public Class RPT_CAR_FIRST_IN_LAST_OUT_frm
    Dim ClsSqlCmd As New ClassCommandSql
    Friend pHeader_Detail As String
    Private Sub RPT_CAR_FIRST_IN_LAST_OUT_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report()
        ...
        'Str_Quy = "Select * from VQR_CAR_FIRST_IN_LAST_OUT "
        Str_Quy = "SELECT [Trn_Log_Date]"
        Str_Quy &= ",[Trn_Tower_ID]"
        Str_Quy &= ",[Tower_Name]"
        Str_Quy &= ",[Trn_Building_ID]"
        Str_Quy &= ",[Building_Name]"
        Str_Quy &= ",[Trn_Floor_No]"
        Str_Quy &= ",[Floor_Name]"
        Str_Quy &= ", PTI_GUIDANCE_CARCOUNT_Project.dbo.GetTimeFristIn(Trn_Building_ID,Trn_Floor_No," & mDB.DBFormatDate(DateSt) & "," & mDB.DBFormatDate(DateEnd) & ") as First_Time"
        Str_Quy &= ", PTI_GUIDANCE_CARCOUNT_Project.dbo.GetTimeLastOut(Trn_Building_ID,Trn_Floor_No," & mDB.DBFormatDate(DateSt) & "," & mDB.DBFormatDate(DateEnd) & ") as Last_Time "
        Str_Quy &= " from VQR_CAR_FIRST_IN_LAST_OUT "
        ...
        Str_Quy &= " group by Trn_Tower_ID,Trn_Log_Date,Trn_Building_ID,Trn_Floor_No,Tower_Name,Building_Name,Floor_Name,Last_Time"
        ...
        RPT = New RPT_CAR_FIRST_IN_LAST_OUT
