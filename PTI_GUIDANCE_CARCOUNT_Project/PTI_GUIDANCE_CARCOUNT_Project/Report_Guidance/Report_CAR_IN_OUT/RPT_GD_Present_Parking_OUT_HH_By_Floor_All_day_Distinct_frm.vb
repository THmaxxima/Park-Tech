...
Public Class RPT_GD_Present_Parking_OUT_HH_By_Floor_All_day_Distinct_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        'Str_Quy = "Select * from GD_Present_Parking_OUT_HH_By_Floor_All_day_Distinct "
        Str_Quy = "Select * from Tbl_Report_GD_Present_Parking_OUT_HH_By_Floor_All_day "
        ...
        If cmb_Tower.SelectedIndex > 0 Then
            ...
            'Str_Quy &= " and  Trn_Tower_ID = '" & cmb_Tower.SelectedValue & "'"
        ...
        Dim RPT As Object
        RPT = New RPT_GD_Present_Parking_OUT_HH_By_Floor_All_day_Distinct
