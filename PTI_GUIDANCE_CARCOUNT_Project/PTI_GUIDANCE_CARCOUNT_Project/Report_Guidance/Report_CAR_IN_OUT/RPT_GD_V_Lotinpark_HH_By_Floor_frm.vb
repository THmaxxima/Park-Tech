...
Public Class RPT_GD_V_Lotinpark_HH_By_Floor_frm
    Dim CDB As New CDatabase
    Public pHeader_Detail As String
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        Str_Quy = "Select * from GD_V_Lotinpark_HH_By_Floor "
        ...
        pDtb_Qury = CDB.readTableData(Str_Quy, ConStr_Guidance)
        Dim RPT As Object
        RPT = New RPT_GD_V_Lotinpark_HH_By_Floor
