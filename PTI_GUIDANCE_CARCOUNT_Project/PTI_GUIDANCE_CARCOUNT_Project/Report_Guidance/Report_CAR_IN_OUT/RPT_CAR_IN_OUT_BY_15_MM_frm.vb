...
Public Class RPT_CAR_IN_OUT_BY_15_MM_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        Str_Quy = "Select * from VQR_CAR_IN_OUT_15_MM_BY_FLOOR " 'VQR_CAR_IN_OUT_BY_15_MM_BY_FLOOR
        ...
        RPT = New RPT_CAR_IN_OUT_15_MM_BY_FLOOR
        ShowReport(pDtb_Qury, pHeader_Detail & " (แสดงรายละเอยดตามชั้น)", RPT, DateSt, DateEnd)
    ...
    Sub Query_Report_ByBuilding()
        ...
        Str_Quy = "Select * from VQR_CAR_IN_OUT_BY_15_MM "
        Str_Quy &= " where (Trn_Time_MM_Start15 between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        RPT = New RPT_CAR_IN_OUT_BY_15_MM
        ShowReport(pDtb_Qury, pHeader_Detail & " (แสดงรายละเอียดตามอาคาร)", RPT, DateSt, DateEnd)
    ...
    Sub Query_Report_ByTower()
        ...
        Str_Quy = "Select * from VQR_CAR_IN_OUT_BY_15_MM_TOWER "
        Str_Quy &= " where (Trn_Time_MM_Start15 between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_IN_OUT_BY_15_MM_TOWER
        ShowReport(pDtb_Qury, pHeader_Detail & " (แสดงรายละเอียดทั้งหมด)", RPT, DateSt, DateEnd)

    End Sub
    Private Sub RPT_CAR_IN_OUT_BY_15_MM_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
