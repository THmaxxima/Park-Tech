...
Public Class RPT_GD_Present_Turn_By_Floor_All_Day_H_N_Distinct_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        'Str_Quy = "Select * from GD_Present_Turn_By_Floor_All_Day_H_N_Distinct "
        Str_Quy = "Select * from Tbl_Report_GD_Present_Turn_By_Floor_All_Day "
        ...
        Dim RPT As Object
        RPT = New RPT_GD_Present_Turn_By_Floor_All_Day_H_N_Distinct
