...
Public Class RPT_GD_V_Parking_HH_By_Week_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        'Str_Quy = "Select * from GD_V_Parking_HH_By_Floor "
        Str_Quy = "SELECT  Trn_Tower_ID, Tower_Name, Trn_Building_ID, Building_Name, Trn_Floor_No, Floor_Name, Floor_Lot_All "
        Str_Quy &= ",  convert(varchar,Trn_Year) + '-' + convert(varchar,Trn_Month) as ym, P_H_01, P_H_02, P_H_03, P_H_04 "
        Str_Quy &= ", P_H_05, P_H_06, P_H_07, P_H_08, P_H_09, P_H_10, P_H_Over_10, P_H_Total "

        Str_Quy &= "FROM  Tbl_Report_GD_V_Parking_HH_By_Floor "
        ...
        Str_Quy &= ",Trn_Month ,Trn_Year, P_H_01, P_H_02, P_H_03, P_H_04 "
        Str_Quy &= ", P_H_05, P_H_06, P_H_07, P_H_08, P_H_09, P_H_10, P_H_Over_10, P_H_Total "
        ...
        Dim RPT As Object
        RPT = New RPT_GD_V_Parking_HH_By_Week
    ...
    End Sub
    Private Sub RPT_GD_V_Parking_HH_By_Floor_frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
