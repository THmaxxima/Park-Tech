...
Public Class RPT_GD_V_Lotvaliable_By_Floor_By_Week_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        'Str_Quy = "Select * from GD_V_Lotvaliable_HH_By_Floor "
        'Str_Quy = "Select * from Tbl_Report_GD_V_Lotvaliable_HH_By_Floor "
        Str_Quy = "SELECT Trn_Tower_ID, Tower_Name, Trn_Building_ID, Building_Name, Trn_Floor_No, Floor_Name "
        Str_Quy &= ", Floor_Lot_All, Lotvaliable_00, Lotvaliable_01, Lotvaliable_02, Lotvaliable_03, Lotvaliable_04 "
        Str_Quy &= ", Lotvaliable_05, Lotvaliable_06, Lotvaliable_07, Lotvaliable_08, Lotvaliable_09, Lotvaliable_10 "
        Str_Quy &= ", Lotvaliable_11, Lotvaliable_12, Lotvaliable_13, Lotvaliable_14, Lotvaliable_15, Lotvaliable_16 "
        Str_Quy &= ", Lotvaliable_17, Lotvaliable_18, Lotvaliable_19, Lotvaliable_20, Lotvaliable_21, Lotvaliable_22, Lotvaliable_23 "
        Str_Quy &= ",  convert(varchar,Trn_Year) + '-' + convert(varchar,Trn_Month) as ym "

        Str_Quy &= " FROM Tbl_Report_GD_V_Lotvaliable_HH_By_Floor "

        Str_Quy &= " WHERE (Trn_Date between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        Str_Quy &= " GROUP BY Trn_Tower_ID, Tower_Name, Trn_Building_ID, Building_Name, Trn_Floor_No, Floor_Name, Floor_Lot_All "
        Str_Quy &= ", Lotvaliable_00, Lotvaliable_01, Lotvaliable_02, Lotvaliable_03, Lotvaliable_04, Lotvaliable_05, Lotvaliable_06 "
        Str_Quy &= ", Lotvaliable_07, Lotvaliable_08, Lotvaliable_09, Lotvaliable_10, Lotvaliable_11, Lotvaliable_12, Lotvaliable_13 "
        Str_Quy &= ", Lotvaliable_14, Lotvaliable_15, Lotvaliable_16, Lotvaliable_17, Lotvaliable_18, Lotvaliable_19, Lotvaliable_20 "
        Str_Quy &= ", Lotvaliable_21, Lotvaliable_22, Lotvaliable_23, Trn_Month, Trn_Year "

        Str_Quy &= " ORDER BY Trn_Tower_ID,Trn_Building_ID,Trn_Floor_No "

        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_GD_V_Lotvaliable_By_Floor_By_Week
    ...
    Sub Query_Report_ByTower()
        ...
        'Str_Quy = "Select * from VQR_CAR_PARKING_HH_BY_DAY_TOWER "
        ...
        'pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        'Dim RPT As Object
        'RPT = New RPT_CAR_PARKING_HH_BY_DAY_TOWER
        'ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)

    End Sub
    Private Sub RPT_GD_V_Lotvaliable_HH_By_Floor_frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Sub Query_Report_ByBuilding()
        ...
        'Str_Quy = "Select * from VQR_CAR_PARKING_HH_BY_DAY "
        'Str_Quy &= " where (Trn_Log_Date between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        'pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        'Dim RPT As Object
        'RPT = New RPT_CAR_PARKING_HH_BY_DAY
        'ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
    ...
    Private Sub cmb_Building_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cmb_Building.SelectedIndexChanged
