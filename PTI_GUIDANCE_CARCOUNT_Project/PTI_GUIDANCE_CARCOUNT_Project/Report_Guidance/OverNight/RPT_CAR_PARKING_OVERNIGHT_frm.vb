...
Public Class RPT_CAR_PARKING_OVERNIGHT_frm
...
Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report()
        ...
        If HH_S.Text <> "" And HH_E.Text <> "" Then Str_Quy &= " and  Trn_Park_HH between '" & HH_S.Text & "' and '" & HH_E.Text & "'"

        If HH_S.Text <> "" And HH_E.Text = "" Then Str_Quy &= " and  Trn_Park_HH >= '" & HH_S.Text & "'"
        ...
        RPT = New RPT_CAR_PARKING_OVERNIGHT
