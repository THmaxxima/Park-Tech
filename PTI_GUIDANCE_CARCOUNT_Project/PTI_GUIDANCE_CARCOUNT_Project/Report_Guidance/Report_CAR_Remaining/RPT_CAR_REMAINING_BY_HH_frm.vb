...
Public Class RPT_CAR_REMAINING_BY_HH_frm
 ...
 Optional ByRef DateEnd As String = "")
    ...
    Sub Query_Report_ByFloor()
        ...
        Str_Quy = "Select * from VQR_CAR_REMAINING_BY_1_HH_BY_FLOOR "
        ...
        Dim RPT As Object
        RPT = New RPT_CAR_REMAINING_BY_HH_BY_FLOOR
    ...
    Sub Query_Report_ByBuilding()
        ...
        Str_Quy = "Select * from VQR_CAR_REMAINING_BY_1_HH "
        Str_Quy &= " where (Trn_Time_HH_Start between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_REMAINING_BY_HH
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)
    ...
    Sub Query_Report_ByTower()
        ...
        Str_Quy = "Select * from VQR_CAR_REMAINING_BY_1_HH_TOWER "
        Str_Quy &= " where (Trn_Time_HH_Start between " & mDB.DBFormatDate(DateSt) & " and " & mDB.DBFormatDate(DateEnd) & ")"
        ...
        pDtb_Qury = ClsSqlCmd.ReturnDatatable_(ConnStrGuidance_RPT, Str_Quy)
        Dim RPT As Object
        RPT = New RPT_CAR_REMAINING_BY_HH_TOWER
        ShowReport(pDtb_Qury, pHeader_Detail, RPT, DateSt, DateEnd)

    End Sub

    Private Sub RPT_CAR_REMAINING_BY_HH_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
