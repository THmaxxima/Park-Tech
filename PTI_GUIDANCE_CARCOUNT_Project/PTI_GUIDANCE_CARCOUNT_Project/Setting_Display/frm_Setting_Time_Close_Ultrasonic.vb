...
Public Class frm_Setting_Time_Close_Ultrasonic
    ...
    Private Sub frm_Setting_Time_Close_Ultrasonic_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Load_Mas_Turn_Off_LED()
    End Sub
