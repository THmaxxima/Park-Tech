...
Public Class frm_Setting_Time_Close_Main_Display
    ...
    Private Sub frm_Setting_Time_Close_Main_Display_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
