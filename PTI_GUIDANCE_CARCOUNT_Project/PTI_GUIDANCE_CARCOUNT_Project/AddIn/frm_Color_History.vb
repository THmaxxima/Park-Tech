...
Public Class frm_Color_History
    ...
    Private Function Function_New_Alam_ID() As String
        ...
        Dim F_ID As String = ""
        Try
            Dim sql As String = "select Max(His_Id) from Mas_Color_History"
    ...
    Sub Delete_Status_Alam()
        ...
        sql = " DELETE From Mas_Color_History WHERE His_Id = '" & lbl_Mas_Alam.Text & "'"
        If OpenCnn(ConnStrMasTer, Conn) Then
            Conn.BeginTrans()
            TrnFlg = True
            Conn.Execute(sql)
...
Err:
    ...
    Sub Update_Mas_Status_Alam()
        ...
        sql = "Update Mas_Color_History set His_Name='" & txt_Mas_Alam.Text & _
              "', His_Color_A = " & Color_A & _
              ", His_Color_R = " & Color_R & _
              ", His_Color_G = " & Color_G & _
              ", His_Color_B = " & Color_B & _
                ", His_Min = " & txt_Min.Text.Trim & _
                ", His_Max = " & txt_Max.Text.Trim & _
        ...
        Exit Sub
Err:
        Call mError.ShowError(Me.Name, "Update_Mas_Color_History", Err.Number, Err.Description)
    End Sub
...
Err_Renamed:
    ...
    Sub Save_Mas_Alam()
        ...
        If OpenCnn(ConnStrMasTer, Conn) Then
            Conn.BeginTrans()
            TrnFlg = True
            sql = " Insert into Mas_Color_History  Values (" & Trim(lbl_Mas_Alam.Text) & _
                  ",'" & txt_Mas_Alam.Text & "'," & Color_A & "," & Color_R & _
                  "," & Color_G & "," & Color_B & "," & txt_Min.Text & ", " & txt_Max.Text & ")"
            Conn.Execute(sql)
...
Err_Renamed:
    ...
    Private Sub frm_Color_History_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call lsv_Select_Mas_Alam_View()
        Call defaulf_Object()
        Call Style_ListView()
    End Sub
