...
Public Class frm_Mas_Status_Alarm
...
Err_Renamed:
    ...
    Private Sub frm_Mas_Status_Alarm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call mMain.Load_AppConfig()
        Call lsv_Select_Mas_Alam_View()
        Call Style_ListView()
        'If User_Level <> "13" Then
        '    btn_Add_Alam.Visible = False
