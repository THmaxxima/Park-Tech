...
Public Class frmNew_Display_Over_HH
    ...
    Private Sub frmNew_Display_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        car_HH = My.Resources.car_full
        car_HH = Get_Image_Hour()
...
Err:
    ...
    Sub Load_Button_New(ByVal floor_no As String, ByVal building_no As String, ByVal zcu_id As String)
        ...
        Try
            ...
            sql &= " where HW_Building_ID = '" & building_no & "' and Floor_No = '" & floor_no & "'"
            If zcu_id <> "" Then
                ...
                For ii As Integer = 0 To DT.Rows.Count - 1
                    ...
                    Else
                        ...
                        Else
                            ...
                            Add_Control_picture(pg_box, name_, location_x, location_y, Tag, car_HH, direction)
                            With pg_box
                                .Text = "        " & _
        ...
        End Try
    End Sub
    Function Get_Image_Hour() As Image
        ...
        Try
            ...
            Dim sql As String = ""
            sql = "SELECT * FROM  [Mas_Hour_Alert] WHERE [HH_ID]='1'"
            Dim DT As DataTable = cdb.readTableData(sql, ConStr_Master)
            If DT.Rows.Count > 0 Then
